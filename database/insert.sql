...
INSERT INTO User (username,fname,lname,email,passwd,imagename,theme,discord,youtube,twitch,created_at,deleted_at,private_acc,banned_at,banned_by,banned_reason) VALUES ('Dummy1','Dummy','User1','blah@blah.fi','1234','','light','discord-link','youtube-link','twitch-link','2010-05-05 12:00:00',NULL,FALSE,NULL,NULL,'');
INSERT INTO User (username,fname,lname,email,passwd,imagename,theme,discord,youtube,twitch,created_at,deleted_at,private_acc,banned_at,banned_by,banned_reason) VALUES ('Dummy2','Silly','User2','blah@blah.fj','1234','','','','','','2010-05-05 12:00:01',NULL,FALSE,NULL,NULL,'');
INSERT INTO User (username,fname,lname,email,passwd,imagename,theme,discord,youtube,twitch,created_at,deleted_at,private_acc,banned_at,banned_by,banned_reason) VALUES ('Dummy3','Fool','User3','blah@blah.fk','1234','','','','','','2010-05-05 12:00:02',NULL,TRUE,NULL,NULL,'');
INSERT INTO User (username,fname,lname,email,passwd,imagename,theme,discord,youtube,twitch,created_at,deleted_at,private_acc,banned_at,banned_by,banned_reason) VALUES ('Dummy4','Dummy','User4','blah@blah.fl','1234','','','','','','2010-05-05 12:00:03',NULL,TRUE,NULL,NULL,'');
INSERT INTO User (username,fname,lname,email,passwd,imagename,theme,discord,youtube,twitch,created_at,deleted_at,private_acc,banned_at,banned_by,banned_reason) VALUES ('Dummy5','Silly','User5','blah@blah.fm','1234','','','','','','2010-05-05 12:00:04',NULL,FALSE,NULL,NULL,'');
INSERT INTO User (username,fname,lname,email,passwd,imagename,theme,discord,youtube,twitch,created_at,deleted_at,private_acc,banned_at,banned_by,banned_reason) VALUES ('Dummy6','Fool','User6','blah@blah.fn','1234','','','','','','2010-05-05 12:00:05',NULL,FALSE,NULL,NULL,'');
